...
*  ver 4.7 : 04 Apr 15
*  - removed testBlockHandling declaration from Socket.cpp MsgServer.
...
*    template method.
*  - renamed ClientProc to MsgServer
...
*  - gave MsgServer a command interpreter to select a test process
...
*  - moved MsgServer into test stub
*  ver 4.3 : 26 Mar 15
