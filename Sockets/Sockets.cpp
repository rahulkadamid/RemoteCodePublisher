...
void MsgServer::operator()(Socket& socket_)
{
  while (true)
  {
  ...
  Show::write("\n");
  Show::write("\n  MsgServer socket connection closing");
  socket_.shutDown();
  socket_.close();
  Show::write("\n  MsgServer thread terminating");
}
...
*/
bool MsgServer::testStringHandling(Socket& socket_)
{
...
*/
bool MsgServer::testBufferHandling(Socket& socket_)
{
